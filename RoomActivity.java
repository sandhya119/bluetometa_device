...
public class RoomActivity extends AppCompatActivity {
    ...
    private void setSleepTimer(int hourOfDay, int minute) {
        ...
        // Send the sleep timer command to Arduino
        sendSleepTimerCommand(hourOfDay, minute);
    }

    private void sendSleepTimerCommand(int hourOfDay, int minute) {
        String command = "T:" + hourOfDay + ":" + minute;
